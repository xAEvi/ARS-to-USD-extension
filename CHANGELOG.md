...
- La extensión está activa por defecto en cualquier página. Subrayar un monto en pesos muestra un
  panel flotante con su equivalente en dólares, la fuente de la cotización usada y su antigüedad,
  incluido un aviso cuando el dato está vencido. Reemplaza al escaneo automático de la página.
- El popup permite desactivarla en el sitio actual, con un indicador en el ícono que muestra cuándo
  está desactivada sin necesidad de abrirlo. La preferencia se recuerda por sitio.
